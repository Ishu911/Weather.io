...
app.post("/search", async (req, res) => {
    ...
    const apiKey = "e557481084fc0cc85a72ecf9a82a085a";
    const apiUrl = `https://api.openweathermap.org/geo/1.0/direct?q=${searchedCity}&limit=3&appid=${"e557481084fc0cc85a72ecf9a82a085a"}`;
    try{
